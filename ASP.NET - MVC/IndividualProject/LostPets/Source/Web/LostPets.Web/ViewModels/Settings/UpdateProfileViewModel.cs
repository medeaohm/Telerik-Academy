namespace LostPets.Web.ViewModels.Settings
{
    ...
    public class UpdateProfileViewModel : IMapFrom<User>
    {
        ...
        //{
        //    configuration.CreateMap<User, UpdateProfileViewModel>()
        //        .ForMember(x => x.AvatarId, opt => opt.MapFrom(x => x.ProfilePictureId.Value));
        //}
    }
}