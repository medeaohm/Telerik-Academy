<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="World.aspx.cs" Inherits="Countries.World" ValidateRequest="false" %>
        ...
        <div>
            ...
            <fieldset>
                ...
                <asp:GridView ID="GridViewCountries" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataKeyNames="CountryId" DataSourceID="EntityDataSourceCountries"
                    ItemType="Countries.Data.Country" ShowFooter="True" OnRowUpdated="GridViewCountries_RowUpdated" OnRowUpdating="GridViewCountries_RowUpdating" OnRowDataBound="GridViewCountries_RowDataBound" OnRowDeleting="GridViewCountries_RowDeleting">
                    <Columns>
