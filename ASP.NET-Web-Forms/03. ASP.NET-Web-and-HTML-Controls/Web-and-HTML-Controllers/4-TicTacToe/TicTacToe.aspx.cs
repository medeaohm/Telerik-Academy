namespace TicTacToe
{
    ...
    public partial class TicTacToe : System.Web.UI.Page
    {
        ...
        private void PrintComputerMove(int index)
        {
            ...
            {
                case 0:
                    this.ButtonTopLeft.Text = this.computerSign;
                    break;
                case 1:
                    this.ButtonTopCenter.Text = this.computerSign;
                    break;
                case 2:
                    this.ButtonTopRight.Text = this.computerSign;
                    break;
                case 3:
                    this.ButtonMiddleLeft.Text = this.computerSign;
                    break;
                case 4:
                    this.ButtonMiddleCenter.Text = this.computerSign;
                    break;
                case 5:
                    this.ButtonMiddleLeft.Text = this.computerSign;
                    break;
                case 6:
                    this.ButtonBottomLeft.Text = this.computerSign;
                    break;
                case 7:
                    this.ButtonBottomCenter.Text = this.computerSign;
                    break;
                case 8:
                    this.ButtonBottomRight.Text = this.computerSign;
                    break;
