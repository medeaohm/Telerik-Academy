        ...
        <div class="search-button">
            <div class="form-serch">
                <div class="input-append">
                    <asp:TextBox runat="server" id="TextBoxSearchParam" type="text" name="q" CssClass="col-md-8 search-query" placeholder="Search by book title / author..." ></asp:TextBox>
                    <asp:LinkButton runat="server" ID="LinkButtonSearch" OnClick="LinkButtonSearch_Click" CssClass="btn btn-primary search-button" Text="Search">Search</asp:LinkButton>
                </div>
            </div>
        </div>
    </div>
