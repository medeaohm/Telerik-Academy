...
<asp:Content ID="ContentBody" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:UpdatePanel runat="server" ID="UpdatePanelInsertBook" cssClass="panel">
        ...
        <ContentTemplate>
            <asp:FormView ID="FormViewInsertBook" runat="server" DefaultMode="Insert" ItemType="LibrarySystem.Models.Book" InsertMethod="FormViewInsertBook_InsertItem" Visible="false">
                <InsertItemTemplate>
