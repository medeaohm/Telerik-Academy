...
class ZeroSubset
    {
        static void Main()
        {
            Console.WriteLine("Give me 5 integer numbers and I will find all subsets of them numbers whose sum is 0...\n");
            ...
            Console.Write("Please insert the forth number...");
            int d = int.Parse(Console.ReadLine());
            Console.Write("Please insert the fifth number...");
