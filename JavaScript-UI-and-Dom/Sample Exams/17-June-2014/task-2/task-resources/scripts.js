/*/// <reference path="/../../../typings/jquery/jquery.d.ts"/>*Y
/* globals $ */
...
$.fn.gallery = function (cols) {
    ...
    $('.next-image').on('click', function () {
        ...
        var $newNextImageSrc;
        var $newPreviosImageSrc;
        //console.log($thisNext.find('img').attr('src'));
        
        $newCurrentImageSrc = $('.next-image').find('img').attr('src');
        $newNextImageSrc = $('.next-image').next().find('img').attr('src');
        $newPreviosImageSrc = $('.current-image').prev().find('img').attr('src');
