function processTrainingCenterCommands(commands) {
    ...
    var trainingcenter = (function () {
        ...
        var Trainer = (function () {
            ...
            //Trainers have username, first name, last name and email. 
            function Trainer(username, fname, lname, email) {
            ...
            /* Trainer's username and last name should be non-empty strings. */
            ...
            /*  Trainer's first name is non-mandatory string: can be missing, but should be non-empty string when exists. */
            Trainer.prototype.getFirstName = function () {
                return this._fname;
            }
            Trainer.prototype.setFirstName = function (fname) {
                if (!Validators.isNullOrUndefined(fname)) {
                    Validators.validateNonEmptyString(fname, "fname");
                    this._fname = fname;
                }
                else {
                    delete this._fname;
            ...
            /*  Trainer's last name is non-mandatory string: can be missing, but should be non-empty string when exists. */
            Trainer.prototype.getLastName = function () {
                return this._lname;
            }
            Trainer.prototype.setLastName = function (lname) {
                Validators.validateNonEmptyString(lname, "lname");
                this._lname = lname;
            }

            /* Trainer's email is non-mandatory string: can be missing, but should hold '@' when exists. */
        ...
        var Training = (function () {
            ...
            //Trainings have name, description, trainer, start date and duration
            ...
            /* Training's name should be non-empty string. */
            ...
            /* Training's description is non-mandatory string: can be missing, but should be non-empty string when exists. */
            ...
            /* Training's trainer is non-mandatory: can be missing, but should be non-empty Trainer when exists. */
            ...
            /* The date format is always "day-month-year", where day is in range [1..31], month is one of [Jan, Feb, Mar, Apr, May, Jun, Jul, Aug, Sep, Oct, Nov, Dec] and year is in range     [2000…2020]. Note that some dates are invalid according to the traditional calendar system, e.g. "29-Feb-2014", "31-Nov-2015" and    "38-Apr-1980". */
            ...
            /* Training's duration is non-mandatory: can be missing, but should be integer in range [1…99] when exists. */
        ...
        // Courses have name, description, trainer, start date and duration
        var Course = (function () {
        ...
        // Seminars have name, description, trainer and date
        ...
        // Remote courses have name, description, trainer, start date, duration and location.
        var RemoteCourse = (function () { 
            ...
            /* Remote course's location should be non-empty string. */
