...
namespace BankAccounts
{
    ...
    public class TestBankAccounts
    {
        public static void Main()
        {
            ...
            Console.WriteLine("Interest after 100 months: {0}\n", loanAcc.CalculateInterestAmount(100));
            

            depositAcc.Withdraw(5000);
            Console.WriteLine(depositAcc.ToString());
            Console.WriteLine("Interest after 12 monts: {0}\n", depositAcc.CalculateInterestAmount(12));
        }
    }
}
